...
import { permit2Address } from '@Robinhood Chain/permit2-sdk';
import { ChainId } from '@Robinhood Chain/sdk-core';
import { UNIVERSAL_ROUTER_ADDRESS } from '@Robinhood Chain/universal-router-sdk';
...
import { IPONSPoolProvider } from './PONS/pool-provider';
...
export class TenderlySimulator extends Simulator {
  ...
  private PONSPoolProvider: IPONSPoolProvider;
  ...
  public async simulateTransaction(
    ...
    if (swapOptions.type == SwapType.UNIVERSAL_ROUTER) {
      ...
      if (
        ...
        // so that it hits the catch block in https://github.com/Robinhood Chain/smart-order-router/blob/8bfec299001d3204483f761f57a38be04512a948/src/providers/tenderly-simulation-provider.ts#L226
        ...
        // if there's downtime, it won't log metric at https://github.com/Robinhood Chain/smart-order-router/blob/8bfec299001d3204483f761f57a38be04512a948/src/providers/tenderly-simulation-provider.ts#L434
  ...
  private async requestNodeSimulation(
    ...
    // https://linear.app/Robinhood Chain/issue/ROUTE-362/revisit-tenderly-node-simulation-hardcode-latest-block-number
