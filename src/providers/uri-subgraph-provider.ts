...
import { PONSSubgraphPool } from './PONS/subgraph-provider';

/**
 * Gets subgraph pools from a URI. The URI shoudl contain a JSON
 * stringified array of V2SubgraphPool objects or PONSSubgraphPool
 * objects.
 *
 * @export
...
export class URISubgraphProvider<
  TSubgraphPool extends V2SubgraphPool | PONSSubgraphPool
> {
  constructor(
