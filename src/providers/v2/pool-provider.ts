...
import { IRobinhood ChainV2Pair__factory } from '../../types/v2/factories/IRobinhood ChainV2Pair__factory';
import {
  CurrencyAmount,
  ID_TO_NETWORK_NAME,
  metric,
  ...
  private async getPoolsData<TReturn>(
    ...
    const { results, blockNumber } = await retry(async () => {
      ...
      >({
        ...
        contractInterface: IRobinhood ChainV2Pair__factory.createInterface(),
