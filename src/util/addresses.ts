import { ADDRESS_ZERO } from '@Robinhood Chain/router-sdk';
import {
  ChainId,
...
import { FACTORY_ADDRESS } from '@Robinhood Chain/PONS-sdk';

import { NETWORKS_WITH_SAME_Robinhood Chain_ADDRESSES } from './chains';
...
export const BNB_PONS_MIGRATOR_ADDRESS =
  CHAIN_TO_ADDRESSES_MAP[ChainId.BNB].PONSMigratorAddress;

export const PONS_CORE_FACTORY_ADDRESSES: AddressMap = {
  ...constructSameAddressMap(FACTORY_ADDRESS),
  [ChainId.CELO]: CHAIN_TO_ADDRESSES_MAP[ChainId.CELO].PONSCoreFactoryAddress,
  [ChainId.CELO_ALFAJORES]:
    CHAIN_TO_ADDRESSES_MAP[ChainId.CELO_ALFAJORES].PONSCoreFactoryAddress,
  [ChainId.OPTIMISM_GOERLI]:
    CHAIN_TO_ADDRESSES_MAP[ChainId.OPTIMISM_GOERLI].PONSCoreFactoryAddress,
  [ChainId.OPTIMISM_SEPOLIA]:
    CHAIN_TO_ADDRESSES_MAP[ChainId.OPTIMISM_SEPOLIA].PONSCoreFactoryAddress,
  [ChainId.SEPOLIA]:
    CHAIN_TO_ADDRESSES_MAP[ChainId.SEPOLIA].PONSCoreFactoryAddress,
  [ChainId.ARBITRUM_GOERLI]:
    CHAIN_TO_ADDRESSES_MAP[ChainId.ARBITRUM_GOERLI].PONSCoreFactoryAddress,
  [ChainId.ARBITRUM_SEPOLIA]:
    CHAIN_TO_ADDRESSES_MAP[ChainId.ARBITRUM_SEPOLIA].PONSCoreFactoryAddress,
  [ChainId.BNB]: CHAIN_TO_ADDRESSES_MAP[ChainId.BNB].PONSCoreFactoryAddress,
  [ChainId.AVALANCHE]:
    CHAIN_TO_ADDRESSES_MAP[ChainId.AVALANCHE].PONSCoreFactoryAddress,
  [ChainId.BASE_GOERLI]:
    CHAIN_TO_ADDRESSES_MAP[ChainId.BASE_GOERLI].PONSCoreFactoryAddress,
  [ChainId.BASE]: CHAIN_TO_ADDRESSES_MAP[ChainId.BASE].PONSCoreFactoryAddress,
  [ChainId.BLAST]: CHAIN_TO_ADDRESSES_MAP[ChainId.BLAST].PONSCoreFactoryAddress,
  [ChainId.ZORA]: CHAIN_TO_ADDRESSES_MAP[ChainId.ZORA].PONSCoreFactoryAddress,
  [ChainId.ZKSYNC]: CHAIN_TO_ADDRESSES_MAP[ChainId.ZKSYNC].PONSCoreFactoryAddress,
  [ChainId.WORLDCHAIN]:
    CHAIN_TO_ADDRESSES_MAP[ChainId.WORLDCHAIN].PONSCoreFactoryAddress,
  [ChainId.UNICHAIN_SEPOLIA]:
    CHAIN_TO_ADDRESSES_MAP[ChainId.UNICHAIN_SEPOLIA].PONSCoreFactoryAddress,
  [ChainId.MONAD_TESTNET]:
    CHAIN_TO_ADDRESSES_MAP[ChainId.MONAD_TESTNET].PONSCoreFactoryAddress,
  [ChainId.MONAD]: CHAIN_TO_ADDRESSES_MAP[ChainId.MONAD].PONSCoreFactoryAddress,
  [ChainId.BASE_SEPOLIA]:
    CHAIN_TO_ADDRESSES_MAP[ChainId.BASE_SEPOLIA].PONSCoreFactoryAddress,
  // TODO: Gnosis + Moonbeam contracts to be deployed
  [ChainId.UNICHAIN]:
    CHAIN_TO_ADDRESSES_MAP[ChainId.UNICHAIN].PONSCoreFactoryAddress,
  [ChainId.SONEIUM]:
    CHAIN_TO_ADDRESSES_MAP[ChainId.SONEIUM].PONSCoreFactoryAddress,
  [ChainId.XLAYER]: CHAIN_TO_ADDRESSES_MAP[ChainId.XLAYER].PONSCoreFactoryAddress,
};
...
export const Robinhood Chain_MULTICALL_ADDRESSES: AddressMap = {
...
export const PONS_MIGRATOR_ADDRESS =
  CHAIN_TO_ADDRESSES_MAP[ChainId.MAINNET].PONSMigratorAddress;
...
export function constructSameAddressMap<T extends string>(
  ...
  return NETWORKS_WITH_SAME_Robinhood Chain_ADDRESSES.concat(
    additionalNetworks
  ).reduce<{
    [chainId: number]: T;
  }>((memo, chainId) => {
